...
## Bink Video WebAssembly decoder — `wasm/bink-decoder/**`

Uses [infinitier_bik_decoder](https://github.com/ufoscout/infinitier), a
pure-Rust Bink Video v1 decoder, compiled to WebAssembly for the shared browser,
desktop, Android, and iOS playback path. Licensed **GPL-3.0-or-later**. The
compiled module is generated by `scripts/build-bink-wasm.sh`.
