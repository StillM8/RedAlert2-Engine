...
| `EMP.Threshold` | To be confirmed by target scan | parser/model only | missing | `AresEMP.test.ts` | [Ares Destroy Units by EMP docs](https://ares-developers.github.io/Ares-docs/new/destroyunitsbyemp.html), [Antares threshold logic](https://github.com/Phobos-developers/Antares/blob/419626d/src/Misc/EMPulse.cpp) | `yes`, `no`, `inair`, and integer thresholds are normalized at rule load. | Airborne/hovering destruction and threshold save/network behavior remain to be implemented. |
