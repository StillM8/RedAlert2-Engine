...
| AttachEffect combat | 820 | 1 | 218 / 218 | parser/model complete; state, trait, combat modifiers, attached animation visibility, and temporary Cloakable source/expiry behavior are wired; residual damage and transport/temporal lifecycle remain partial |
...
| --- | --- | --- | --- |
| AttachEffect combat | 820 occurrences; 218 definitions | `AttachEffect.SpeedMultiplier`, `ArmorMultiplier`, `FirepowerMultiplier`, `ROFMultiplier` plus existing duration/protection fields | Speed, armor, firepower, ROF callsites, attached animation visibility, and temporary Cloakable source/expiry behavior are wired; residual damage, transport/temporal lifecycle, save/load, and lockstep replay remain |
...
runtime gaps remain AttachEffect residual damage,
