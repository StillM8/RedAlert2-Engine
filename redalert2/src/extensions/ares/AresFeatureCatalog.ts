...
export const ARES_IMPLEMENTATION_CAPABILITIES: readonly AresCapability[] = [
    ...
    },
    {
        ...
        documentedKeys: ["[General]ChronoInfantryCrush", "[TechnoType]Chronoshift.Allow", "[BuildingType]Chronoshift.IsVehicle", "[TechnoType]Chronoshift.Crushable", "Chronosphere.ReconsiderBuildings", "Chronosphere.KillOrganic", "Chronosphere.KillTeleporters", "Chronosphere.AffectsIronCurtain", "Chronosphere.AffectsUnwarpable", "Chronosphere.AffectsUndeployable", "Chronosphere.BlowUnplaceable", "Chronosphere.KillCargo"],
        documentedSections: ["General", "TechnoType", "BuildingType", "SuperWeapon"],
        parserStatus: "complete",
        normalizedModelStatus: "complete",
        runtimeStatus: "partial",
        aiStatus: "missing",
