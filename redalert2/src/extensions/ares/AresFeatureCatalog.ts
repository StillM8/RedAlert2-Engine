...
export const ARES_IMPLEMENTATION_CAPABILITIES: readonly AresCapability[] = [
    ...
    },
    {
        ...
        category: "new",
        sourceDocuments: ["new/superweapons.rst"],
        documentedKeys: ["SW.Animation", "SW.AnimationVisibility", "SW.Sound", "SW.ActivationSound"],
        documentedSections: ["SuperWeapon"],
        parserStatus: "complete",
        normalizedModelStatus: "complete",
        runtimeStatus: "partial",
        ...
        dependencies: ["ares.effective-ini"],
        targetModUsage: "required",
        notes: "Authored SW.Animation, SW.AnimationVisibility, SW.Sound, and SW.ActivationSound flow through shared deferred render/audio events from the common activation path. Full animation/sound asset parity, AI, persistence, and network certification remain open.",
    },
    {
        id: "ares.ifv-modes",
