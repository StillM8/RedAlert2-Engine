...
const OVERRIDES: Readonly<Record<string, CapabilityOverride>> = {
    ...
    "new/superweapons.rst": {
        ...
        verificationStatus: "synthetic", deterministic: true, tests: ["AresSuperWeapons.test.ts", "AresSuperWeaponTargeting.test.ts", "AresUnitDelivery.test.ts", "AresSonarPulse.test.ts", "AresDropPod.test.ts"],
        dependencies: ["ares.effective-ini", "ares.target-filters"], targetModUsage: "required",
        notes: "Common fields, manual SW.RequiresTarget/SW.RequiresHouse gates, target filters, GenericWarhead, UnitDelivery, SonarPulse, the EMPulse launch state, and the Antares DropPod core placement handler are present; animation/presentation, AI, persistence, and the remaining handlers are not complete.",
    },
    "restored/emp.rst": {
