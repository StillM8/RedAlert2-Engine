...
const OVERRIDES: Readonly<Record<string, CapabilityOverride>> = {
    ...
    "new/weapons.rst": {
        ...
        dependencies: ["ares.effective-ini"], targetModUsage: "required",
        notes: "Beam.Color/IsHouseColor/Duration/Amplitude, Bolt.Color1/2/3, Wave.IsLaser/IsBigLaser/Color/IsHouseColor, and standalone [WeaponTypes] names are parsed. Rad-beam timing/amplitude, electric-bolt colors, and laser/sonic wave presentation are consumed by the shared renderer; full native wave direction/ambient-damage and multiplayer certification remain open.",
    },
    "new/chronoprisons.rst": {
...
export const ARES_IMPLEMENTATION_CAPABILITIES: readonly AresCapability[] = [
    ...
    },
    {
        ...
        documentedKeys: ["[WeaponTypes]", "Beam.Color", "Beam.IsHouseColor", "Beam.Duration", "Beam.Amplitude", "Bolt.Color1", "Bolt.Color2", "Bolt.Color3", "Wave.IsLaser", "Wave.IsBigLaser", "Wave.Color", "Wave.IsHouseColor"],
        ...
        dependencies: ["ares.effective-ini"],
        targetModUsage: "required",
        notes: "Weapon visual fields are parsed with Ares defaults and wired into the shared render layer: Beam color/house color/duration/amplitude, all three electric-bolt colors, and enabled laser/sonic wave meshes with custom/house colors. Wave direction, ambient damage, native wave lifecycle, save/load, and multiplayer certification remain open.",
    },
    {
