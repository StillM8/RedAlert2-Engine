...
const DOCUMENTED_KEYS: Readonly<Record<string, readonly string[]>> = {
    ...
    "new/customizableveterancy.rst": ["Trainable", "Experience.FromPassengers", "Experience.PromotePassengers", "Experience.PassengerModifier", "Experience.FromAirstrike", "Experience.AirstrikeModifier", "Experience.SpawnOwnerModifier", "Experience.MindControlSelfModifier"],
...
export const ARES_IMPLEMENTATION_CAPABILITIES: readonly AresCapability[] = [
    ...
    },
    {
        ...
        documentedKeys: ["Trainable", "Experience.FromAirstrike", "Experience.PromotePassengers", "Experience.SpawnOwnerModifier", "Experience.MindControlSelfModifier"],
        ...
        dependencies: ["ares.effective-ini"],
        targetModUsage: "required",
        notes: "The MO-authored source, passenger, spawned-owner, mind-controller, and Trainable=no decisions are routed through generic kill attribution. Official passenger/airstrike modifier variants not used by this MO slice, complete occupier/passenger lifecycle behavior, presentation, AI, persistence, multiplayer, and target-content certification remain open.",
    },
    {
        id: "ares.bounty",
    ...
    },
    {
        ...
        documentedKeys: ["Type=GenericWarhead", "Type=UnitDelivery", "Type=EMPulse", "Type=SonarPulse", "Type=DropPod", "Type=HunterSeeker", "Type=Battery", "Type=Firestorm", "Type=ChronoWarp"],
    ...
    },
    {
        ...
        dependencies: ["ares.effective-ini", "ares.target-filters"],
        targetModUsage: "required",
        notes: "Parser/evaluator, generic owner adapter, provider-based grant/revoke, AlwaysGranted, finite Shots, and activation-time shot gating are implemented. The presentation adapter only normalizes ShowCameo, TimerVisibility, and Group for future consumers; shared UI integration, broader AI certification, persistence, and multiplayer/network certification remain partial.",
    },
];
