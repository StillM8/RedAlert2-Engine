...
const DOCUMENTED_KEYS: Readonly<Record<string, readonly string[]>> = {
    ...
    "new/promotion.rst": ["[AudioVisual]VeteranFlashTimer", "Promote.VeteranSound", "Promote.EliteSound", "Promote.VeteranFlash", "Promote.EliteFlash", "EVA.VeteranPromoted", "EVA.ElitePromoted", "[TechnoType]Experience.PromotePassengers"],
...
const OVERRIDES: Readonly<Record<string, CapabilityOverride>> = {
    ...
    "new/promotion.rst": {
        capabilityId: "ares.promotion-presentation",
        parserStatus: "complete", normalizedModelStatus: "complete", runtimeStatus: "partial",
        aiStatus: "missing", presentationStatus: "partial", saveLoadStatus: "missing", multiplayerStatus: "partial",
        verificationStatus: "synthetic", deterministic: true,
        tests: ["AresPromotionSettings.test.ts"],
        dependencies: ["ares.effective-ini"], targetModUsage: "required",
        notes: "Per-type Promote.VeteranSound/Promote.EliteSound override the global [AudioVisual] sounds and EVA.VeteranPromoted/EVA.ElitePromoted override EVA_UnitPromoted at the shared promotion event; VeteranFlashTimer/EliteFlashTimer and per-type flash frames are parsed. The promotion event carries the achieved rank. Per-unit visual flashing, persistence, and multiplayer certification remain open.",
    },
    "new/weapons.rst": {
