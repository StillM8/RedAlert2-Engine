...
export const DEFAULT_ARES_FEATURES: readonly ExtensionFeature[] = [
    ...
    },
    {
        ...
        parserImplemented: true,
        runtimeImplemented: true,
        tests: ["AresAttachEffect.test.ts", "AresAttachEffectRuntime.test.ts", "AresAttachEffectTraitBridge.test.ts", "AresAttachEffectObjectFactory.test.ts", "AresCompatibilityScanner.test.ts"],
        notes: "The documented AttachEffect fields are normalized for TechnoType and Warhead sections; ObjectFactory registration and a generic trait cover automatic TechnoType spawn timing, renewal, protection retry, effect instances, reapplication/stacking decisions, expiry, entry discard, and aggregate numeric modifiers. Animation/cloak/combat application, transport/temporal lifecycle, save/load, and deterministic multiplayer replay remain open.",
    },
    {
        id: "ares.unknown-key",
