...
export const DEFAULT_ARES_FEATURES: readonly ExtensionFeature[] = [
    ...
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "Mental Omega uses IFVMode values across infantry and vehicle definitions. Generic support must preserve passenger-selected weapons, turret indices, tooltip labels, and VoiceIFVRepair without assuming the vanilla FV identity.",
    },
    {
        id: "ares.powered-by",
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "PoweredBy is an official Ares provider extension used by Mental Omega. Provider resolution must remain data-defined and share the generic power/availability model.",
    },
    {
    ...
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "The scanner records MO usage of RequiredHouses, ForbiddenHouses, AuxBuildings, NegBuildings, AllowPlayer, AllowAI, Shots, AlwaysGranted, ShowCameo, TimerVisibility, and Group. A shared availability/grant service is the next P0 implementation task.",
    },
    {
    ...
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "Mental Omega uses the official AttachEffect family on TechnoTypes and Warheads. Generic effect attachment, stacking, timing, animation, combat modifiers, transport behavior, save/load, and deterministic replay remain open.",
    },
    {
        id: "ares.unknown-key",
