...
export const DEFAULT_ARES_FEATURES: readonly ExtensionFeature[] = [
    ...
    },
    {
        ...
        tests: [],
        notes: "The official Ares field family is present in the MO rules data. It is tracked separately from generic vanilla ChronoSphere behavior until object eligibility and deployed-building semantics are wired and verified.",
    },
    {
        ...
        parserImplemented: true,
        runtimeImplemented: false,
        tests: ["AresChronoPrisons.test.ts", "AresCompatibilityScanner.test.ts"],
        notes: "The documented Abductor, Abductor.Temporal, Abductor.ChangeOwner, health gates, PassengerTurret, and ImmuneToAbduction fields are normalized generically. Passenger insertion, temporal removal, owner changes, turret switching, and persistence remain open.",
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "Insignia and InsigniaFrame fields are official Ares presentation data used by Mental Omega; SHP lookup, frame selection, enemy visibility, and save/mod-hash coverage remain open.",
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "Mental Omega uses Trainable across TechnoTypes. The generic veterancy rules must preserve Ares' untrainable and occupier behavior without branching on MO object names.",
    },
    {
        id: "ares.bounty",
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "Bounty, Bounty.Display, value tiers, BountyEnablers, BountyDisplay, and GivesBounty are official Ares fields observed in the profile data; economy, combat, presentation, and persistence semantics remain open.",
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "Mental Omega uses DamageParticleSystems heavily. The current rules/render path reads the base list, but Ares DamageSparks, DamageSmokeParticleSystems, and DamageSparksParticleSystems semantics still need a dedicated generic runtime verification.",
    },
    {
        ...
        parserImplemented: true,
        runtimeImplemented: false,
        tests: ["AresUrbanCombat.test.ts", "AresCompatibilityScanner.test.ts"],
        notes: "The documented UC.PassThrough/FatalRate/DamageMultiplier, SubjectToTrenches, Bunker.Raidable, advanced rubble, IsTrench, and CanBeOccupiedBy fields are normalized generically. Occupant combat, traversal, capture, rubble transitions, foundation validation, and persistence remain open.",
    },
    {
        id: "ares.pcx-cameos",
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "CameoPCX, AltCameoPCX, and SidebarPCX are official Ares fields observed in the profile data; they need parser, asset lookup, presentation, and save/mod-hash coverage.",
    },
    {
        ...
        runtimeImplemented: false,
        tests: [],
        notes: "CanBeReversed is an official Ares TechnoType field present in the scanned rules. Reverse-engineering support must remain separate from ordinary Techno prerequisites and be verified through building, production, AI, and save paths.",
    },
    {
        id: "ares.ifv-modes",
        ...
        parserImplemented: true,
        runtimeImplemented: false,
        tests: ["AresTechnoExtensions.test.ts", "AresCompatibilityScanner.test.ts"],
        notes: "IFVMode, 1-based WeaponTurretIndexX, WeaponUINameX, and VoiceIFVRepair are normalized generically. Passenger-selected weapons, turret switching, tooltip fallback, voice fallback, save/load, and multiplayer synchronization remain open.",
    },
    {
        id: "ares.powered-by",
        ...
        runtimeImplemented: false,
        tests: ["AresTechnoExtensions.test.ts", "AresCompatibilityScanner.test.ts"],
        notes: "PoweredBy alternatives are normalized as an ordered data-defined OR-list. Provider resolution, power output, unit disablement, superweapon availability, save/load, and multiplayer synchronization remain open.",
    },
    {
    ...
    },
    {
        ...
        parserImplemented: true,
        runtimeImplemented: false,
        tests: ["AresAttachEffect.test.ts", "AresCompatibilityScanner.test.ts"],
        notes: "The documented AttachEffect fields are normalized for TechnoType and Warhead sections, including timing, stacking, multipliers, animation, and future-field provenance. Effect attachment, stacking runtime, timing, animation, combat modifiers, transport behavior, save/load, and deterministic replay remain open.",
    },
    {
        id: "ares.unknown-key",
